...
GameField* FieldBuilder::CreateField() {
	...
	field->selection[LEFT]  = new Draw(src, "res/images/gameplay/selectionLEFT.bmp",150);
	field->selection[RIGHT] = new Draw(src, "res/images/gameplay/selectionRIGHT.bmp",150);
	field->selection[HIGH]  = new Draw(src, "res/images/gameplay/selectionHIGH.bmp",150);
	field->selection[LOW]   = new Draw(src, "res/images/gameplay/selectionLOW.bmp",150);
